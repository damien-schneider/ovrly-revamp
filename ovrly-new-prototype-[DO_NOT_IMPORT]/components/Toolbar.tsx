...
export const Toolbar: React.FC<ToolbarProps> = ({
  ...
  return (
    <div className="fixed top-4 left-1/2 z-[100] flex -translate-x-1/2 flex-row items-center gap-1 rounded-2xl border border-gray-200 bg-white p-1.5 shadow-xl">
      ...
      <button
        className={`group relative rounded-xl p-2.5 transition-all ${isHandTool || activeTool ? "text-gray-500 hover:bg-gray-50 hover:text-gray-900" : "bg-blue-50 text-blue-600 shadow-sm"}`}
        onClick={() => {
          setHandTool(false);
          onSetTool(null);
        }}

...
export const Route = createFileRoute("/overlays/$projectId/view")({
  component: OverlayViewPage,
});

function OverlayViewPage() {
    ...
    >
      {sortedElements.map((el) => {
        ...
        return (
          ...
          >
            <ElementRenderer element={el} isLiveView projectId={projectId} />
          </div>
        );
      })}
    </div>
